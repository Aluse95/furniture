      ...
      <div class="row col-mb-30">
        ...
        <div class="col-lg-4">
          <div class="widget subscribe-widget clearfix" data-loader="button">
            ...
            <form id="widget-subscribe-form" action="<?php echo e(route('frontend.contact.store')); ?>" method="post" class="mb-0 form_ajax">
              <?php echo csrf_field(); ?>
  ...
  <div id="copyrights" class="py-3 bg-color-light">
    <div class="container">
      <div class="d-flex justify-content-between op-04">
        <span>&copy; 2022 Bản quyền thuộc về FHM Agency</span>
