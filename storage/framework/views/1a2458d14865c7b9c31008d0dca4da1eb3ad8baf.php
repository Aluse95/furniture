      ...
      <div class="container clearfix">
            ...
            <div class="row gutter-40">
              <div class="col-md-6">
                <div class="product-image">
                  <img src="<?php echo e($image); ?>" alt="Image 1"/>
        ...
        <div class="w-100">
          <?php if(isset($relatedPosts) && count($relatedPosts) > 0): ?>
            <h4 class="title-widget text-uppercase mt-4"><?php echo app('translator')->get('Related Products'); ?></h4>
                ...
                <div class="oc-item">
                  <div class="product">
                    ...
                    <div class="product-desc center">
                      ...
                      <div class="product-price">
                        <ins><?php echo e(number_format($price_item, 0,',','.')); ?>đ</ins>
                      </div>
                    </div>
                  </div>
                </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\furniture\resources\views/frontend/pages/product/detail.blade.php ENDPATH**/ ?>